document.addEventListener("DOMContentLoaded", () => {
  ...
  const shopItems = [
      { id: "Cj", name: "Grove Street Attack", price: 100, image: "../images/Cj_eleccion.png" },
      { id: "Diddy", name: "Oil on top", price: 100, image: "../images/Diddy_eleccion.png" },
      { id: "Franco", name: "Golpe de Estado", price: 666, image: "../images/Franco_eleccion.png" },
      { id: "churumbel", name: "Puuuuummm!!!", price: 340, image: "../images/churumbel_eleccion.png" },
      { id: "among", name: "Apuñalada silenciosa", price: 320, image: "../images/Among_eleccion.png" },
      { id: "Walter", name: "Pastillaso azul", price: 500, image: "../images/Walter_eleccion.png" },
  ];
